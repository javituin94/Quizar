 ...
 */
public class FactoriaQuestionsSeries extends FactoriaQuestions {
    int id_pregunta;
    String pregunta;
    String resp1;
    String resp2;
    ...
    FactoriaQuestionsSeries(){
    }

    FactoriaQuestionsSeries(FactoriaQuestions pregres){
    ...
    FactoriaQuestionsSeries(String pregun, String resp1, String resp2, String resp3, String resp4, int correct, String img, String sonido){
